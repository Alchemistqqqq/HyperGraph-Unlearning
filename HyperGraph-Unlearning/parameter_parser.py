...
def parameter_parser():
    ...
    parser.add_argument('--dataset', type=str, default='CoauthorshipDBLP', choices=[
        "Cooking200",
        "CoauthorshipCora",
        "CoauthorshipDBLP",
        "CocitationCora",
    ...
    parser.add_argument('--model', type=str, default='HGNN', choices=["HGNNP", "HGNNP","HNHN"], help='Model to use.')
    ...
    parser.add_argument('--aggregation_method', type=str, default='majority_voting',
                        choices=['majority_voting', 'average_voting', 'weighted_average_voting','lbaggr'],
