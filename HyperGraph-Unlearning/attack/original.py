...
def main():
    ...
    original_posteriors = get_posteriors(net, X, G).cpu().numpy()
    with open('original_posteriors.pkl', 'wb') as f:
        pickle.dump(original_posteriors, f)
    print("Original posteriors saved to 'original_posteriors.pkl'")
