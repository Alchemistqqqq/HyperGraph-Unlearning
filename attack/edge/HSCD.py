...
def main():
    ...
    # 这里修改为让 forget_edges 返回新的边列表和遗忘边的索引
    ...
    # 调用成员推断攻击，传入原始后验、当前后验、遗忘边的索引、训练和测试掩码
    evaluate_attack_performance(original_posteriors, current_posteriors, train_mask.to(device), forget_indices, test_mask.to(device))
