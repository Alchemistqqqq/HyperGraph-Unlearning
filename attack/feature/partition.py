...
def main():
    ...
    for i, subgraph in enumerate(subgraphs):
        ...
        sub_X, _ = forget_node_features(sub_X, train_mask, args['forget_ratio'])
        
        best_state, best_epoch = train_and_evaluate_model(sub_net, X, sub_G, lbl, train_mask, val_mask, sub_optimizer, args['num_epochs'], device)
