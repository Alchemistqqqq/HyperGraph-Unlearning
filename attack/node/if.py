...
def print_statistics(train_mask, val_mask, test_mask, forget_indices=None):
    ...
    if forget_indices is not None:
        print(f"Forgotten nodes: {len(forget_indices)}")
...
def main():
    ...
    # Load original posteriors for attack evaluation
    ...
    unlearn_grads = compute_gradients(net, X, G, lbl, new_train_mask, device)
